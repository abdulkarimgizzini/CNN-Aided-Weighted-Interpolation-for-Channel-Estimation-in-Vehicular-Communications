function [Ck_Cofficients] = Interpolation_Cofficients_DFT(nSym, fD, Tsymbol, noise_power_OFDM_Symbols, ERR_DFT)
...
B44_Temp = 1 + (((noise_power_OFDM_Symbols(1, i - 1)) * ERR_DFT));
